...
ggsave("static/logo/geocompx-logo-only2026.png", logo_only, width = 4, height = 4, dpi = 600, bg = NULL, device = ragg::agg_png)
ggsave("static/logo/geocompx-logo-vertical2026.png", logo_vertical, width = 5.5, height = 5, dpi = 600, bg = NULL, device = ragg::agg_png)
ggsave("static/logo/geocompx-logo-horizontal2026.png", logo_horizontal, width = 11, height = 4, dpi = 600, bg = NULL, device = ragg::agg_png)
...
ggsave("static/logo/geocompx-logo-vertical-white2026.png", logo_vertical_white, width = 5.5, height = 5, dpi = 600, bg = NULL, device = ragg::agg_png)
...
ggsave("static/logo/geocompx-logo-horizontal-white2026.png", logo_horizontal_white, width = 11, height = 4, dpi = 600, bg = NULL, device = ragg::agg_png)
