...
description: "A comparison of three popular machine learning frameworks in R for spatial machine learning tasks."
author:
  - name: Jakub Nowosad
...
At the same time, many additional steps can be added to the workflow, such as feature engineering, variable selection, hyperparameter tuning, model interpretation, and more.
In the next blog posts, we will show the three frameworks in more detail, and then also present some other packages that can be used for spatial machine learning in R.
