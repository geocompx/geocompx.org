...
block_folds <- spatialsample::spatial_block_cv(temperature_train, v = 4, n = 2)
...
learner = mlr3::lrn("regr.ranger", importance = "impurity_corrected")
resampling = mlr3::rsmp("repeated_spcv_coords", folds = 5, repeats = 20) 
```
...
```{r}
model_mlr3 = mlr3::resample(task = task,
                            learner = learner,
...
AOA_mlr3 = CAST::aoa(newdata = predictor_stack,
