...
We introduce a new, work-in-progress book on spatial data visualization in R using the **tmap** package. 
...
It includes an overhaul of the internal structure, improved and expanded syntax, and new features that enhance its capabilities.
These features include improved default color palettes, additional options for positioning map elements, tools to assist in selecting map projections, the ability to create bivariate maps, expanded faceting options, and more.

![Examples of map projections for the whole world](fig-exprojs-1.png)
  
Additionally, a system of extensions has been introduced, allowing creation of packages that add new map layers, allow for other spatial classes, or provide connections to additional visualization libraries.
Currently, there are several extensions available, including **tmap.cartogram**, **tmap.glyphs**, **tmap.networks**, and **tmap.mapgl**.

Given the broad range of features and capabilities of the **tmap** package, there is a need for comprehensive documentation and guidance on how to use it for spatial data visualization effectively.
...
![Visual variables in tmap](fig-visual-variables-1.png)
...
![An example of a bivariate map created with tmap](fig-tmrastbiv-2.png)

The book is divided into five parts:

1. Basics. It should allow you to create simple maps quickly.
2. Building blocks. This part explains the core components of **tmap**, including shapes, layers, and visual variables, and how to customize map appearance with legends, scales, and layouts.
...
- Reporting issues or suggesting improvements on the book's [GitHub repository](https://github.com/geocompx/tmap) or through our social media channels
...
We welcome contributions from anyone interested in helping to improve the book and make it a valuable resource for the R, R spatial, and geospatial community, in general.