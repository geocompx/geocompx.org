...
Next, let's dive deeper -- how does it work?
...
It creates a simple book with exercises and their solutions.

## Outro

Overall, we are happy with the current solution setup.
However, as always, there may be better ways to provide books' solutions that we are not aware of, or some parts of our setup could be improved.
