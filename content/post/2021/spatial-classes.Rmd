...
This blog post summarizes how to move between different existing R spatial vector and raster classes.
...
Additionally, the move from the spatial vector data model to the spatial raster data model (and vice versa) is also possible. 
