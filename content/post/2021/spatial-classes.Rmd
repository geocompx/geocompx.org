...
Additionally, the blog post demonstrates how switching from the spatial vector data model to the spatial raster data model (and vice versa) is also possible. 
