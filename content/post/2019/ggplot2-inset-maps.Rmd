...
[Enrico Spinielli](https://twitter.com/espinielli/) asked about how to create inset maps in R to provide a geographic context:

```{r echo=FALSE, eval=TRUE}
blogdown::shortcode("tweet", "1191452410394361863")
```

Nowadays, it can be done in R in many ways using different approaches and packages.
...
Here, we use **ggplot2** for visualization.
We also attach the **sf** package for spatial data reading and handling, **cowplot** to arrange inset maps, and **rcartocolor** for additional color palettes.
