...
This advice comes with a caveat: there is no universally 'right' way of doing things, and there are many other R packages for working with spatial data in R.
We hope this condensed "Too Long Didn't Read" (TLDR) guide is useful (see caveats in subsequent sections).

# 2. TLDR: installing spatial R packages on Ubuntu
