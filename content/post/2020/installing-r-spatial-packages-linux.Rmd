...
Like cars, people tend to go for computer technologies that are easy to use, that are 'plug and play', so it's important for the future of open source software that the solutions we recommend are easy to set-up and use.
]
