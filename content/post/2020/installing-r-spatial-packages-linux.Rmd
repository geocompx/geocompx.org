...
By 'key packages' I mean they following, which enable the majority of day-to-day geographic data processing and visualization tasks:
...
That set-up should work fine for the vast majority of people, but if you want more up-to-date versions of GEOS, GDAL and PROJ than those shown above, see Section 3 below.
...
# 2. Installing geographic R packages on other Linux operating systems
...
# 3. How close to the bleeding edge should you get?
