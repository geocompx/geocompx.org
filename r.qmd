...
::: {.g-col-12 .g-col-md-6}
<a href="https://tmap.geocompx.org/"><img width=80% src="https://tmap.geocompx.org/images/cover_tmp_all_mockup.png"/></a>
:::

::: {.g-col-12 .g-col-md-6}
[Spatial Data Visualization with tmap: A Practical Guide to Thematic Mapping in R](https://tmap.geocompx.org/) by Martijn Tennekes and Jakub Nowosad is a comprehensive guide to creating maps using the **tmap** package in R.
:::
